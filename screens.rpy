...
screen quick_menu():
    ...
    if quick_menu:
        ...
        imagemap:
            ...
            # idle "ui/qm/qm_idle.png"
            hover "ui/qm/hover.png"
            ground "ui/qm/ground.png"

            hotspot (1548, 906, 344, 62) action ShowMenu('pause_menu')
            hotspot (1548, 835, 346, 63) action ShowMenu('save')
            hotspot (1728, 976, 169, 55) action Skip() alternate Skip(fast=True, confirm=True)
            hotspot (1547, 977, 160, 54) action Rollback()
...
screen main_menu():
    ...
    imagemap:
        ...
        hotspot (655, 655, 645, 193) action Start()
        hotspot (300, 859, 441, 133) action ShowMenu("load")
        hotspot (807, 848, 313, 147) action Quit(confirm=False)
        hotspot (1174, 851, 473, 152) action ShowMenu("preferences")
...
screen save():
    ...
    imagemap:
        ...
        hotspot (749, 223, 353, 198) clicked FileSave(1):
            use load_save_slot(number=1)
        hotspot (750, 457, 352, 198) clicked FileSave(2):
            use load_save_slot(number=2)
        hotspot (749, 689, 353, 196) clicked FileSave(3):
            use load_save_slot(number=3)

        hotspot (625, 940, 682, 54) action Return()
        ...
        hotspot (852, 903, 36, 35) clicked FilePage(1)
        hotspot (893, 901, 39, 36) clicked FilePage(2)
        hotspot (938, 904, 46, 34) clicked FilePage(3)
        hotspot (987, 898, 33, 36) clicked FilePage(4)
        hotspot (1034, 900, 34, 38) clicked FilePage(5)
...
screen load():
    ...
    imagemap:
        ...
        hotspot (749, 223, 353, 198) clicked FileLoad(1):
            use load_save_slot(number=1)
        hotspot (750, 457, 352, 198) clicked FileLoad(2):
            use load_save_slot(number=2)
        hotspot (749, 689, 353, 196) clicked FileLoad(3):
            use load_save_slot(number=3)
...
screen pause_menu():
    ...
    imagemap:
        auto "ui/pm/pm_%s.png"

        hotspot (624, 269, 681, 84) action MainMenu(confirm=True)
        hotspot (624, 398, 679, 83) action ShowMenu("preferences")
        hotspot (627, 531, 673, 83) action ShowMenu('load')
        hotspot (624, 656, 676, 83) action ShowMenu('save')
        hotspot (627, 780, 673, 81) action Quit(confirm=True)
        hotspot (619, 940, 681, 54) action Return()
...
screen preferences():
    ...
    imagemap:
        ground "ui/preferences/ground.png"
        hover "ui/preferences/hover.png"
        idle "ui/preferences/idle.png"

        selected_hover "ui/preferences/select_hover.png"
        selected_idle "ui/preferences/select_hover.png"

        hotspot (675, 310, 266, 36) action Preference('display', 'window')
        hotspot (984, 311, 260, 38) action Preference('display', 'fullscreen')

        hotspot (673, 493, 262, 36) action Preference("skip", "toggle")
        hotspot (982, 489, 266, 42) action Preference("after choices", "toggle")

        hotbar (673, 850, 575, 41) value Preference('text speed')
        hotspot (1212, 812, 174, 32) action Preference("all mute", "enable")

        hotbar (673, 672, 264, 34) value Preference("music volume")
        hotbar (986, 672, 260, 38) value Preference("sound volume")

        hotspot (626, 944, 667, 37) action Return()
